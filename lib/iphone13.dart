...
class Iphone13Bar extends StatelessWidget {
  const Iphone13Bar({ Key? key }) : super(key: key);
        ...
        child: Container(
          child: Column(
            children: [
              ...
              Image.asset('assets/images/iphone13.jfif'),
              SizedBox(height: 24.0,),
              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children:
              [
                Text("THE IPHONE SERIES; 13PRO MAX"),
              ...
              Text('It ranges from #500,000 to #550,000'),
              SizedBox(height: 24.0),
